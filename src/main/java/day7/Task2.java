...
public class Task2 {
    public static void main(String[] args) {
        ...
        int stam = random.nextInt(11) + 90;

        Player player1 = new Player(stam);
        Player player2 = new Player(stam);
        Player player3 = new Player(stam);
        Player player4 = new Player(stam);
        Player player5 = new Player(stam);
        Player player6 = new Player(stam);
